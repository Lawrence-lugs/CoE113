...
# DVE full session
# Saved on Wed Feb 5 10:03:53 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.3} -show_state normal -rect {{8 70} {846 853}}
...
gui_sg_addsignal -group "$_session_group_7" { tb_reg.REGFILE.rd_addrA tb_reg.REGFILE.rd_addrB tb_reg.REGFILE.rd_dataA tb_reg.REGFILE.rd_dataB tb_reg.REGFILE.wr_addr tb_reg.REGFILE.wr_data tb_reg.REGFILE.clk tb_reg.REGFILE.nrst tb_reg.REGFILE.wr_en }

set _session_group_8 Group2
gui_sg_create "$_session_group_8"
set Group2 "$_session_group_8"

gui_sg_addsignal -group "$_session_group_8" { tb_reg.MEM.data_in tb_reg.MEM.data_out tb_reg.MEM.memory }

set _session_group_9 Group4
gui_sg_create "$_session_group_9"
set Group4 "$_session_group_9"

gui_sg_addsignal -group "$_session_group_9" { tb_reg.data_in_mem tb_reg.data_out_mem }
...
gui_wv_zoom_timerange -id ${Wave.2} 339472 359353
