...
struct iptmpl {
    QIRD  * I597;
    struct vcs_globals_t * I598;
    void * I600;
    UP  I601;
    UP  I602;
    struct iptmpl * I595[2];
};
typedef unsigned long long FileOffset;
typedef struct _hsimPeriodL {
    char  I736[256];
    struct _hsimPeriodL * I708;
} HsimPeriodL;
typedef struct {
    U   I738[2];
    U  I739 :1;
    ...
    unsigned long long I747;
    unsigned long long I748;
    unsigned long long I749;
    U  I750;
    U  I751;
    U  I752;
    U  I753;
...
struct dummyq_struct {
    ...
    struct futq * I853;
    struct futq * I854;
    struct sched_table * I855;
    struct millenium * I857;
    EBLK  * I859;
    EBLK  * I860;
    EBLK  * I861;
    EBLK  * I862;
...
void  hsM_14_5(UB  * pcode, UB  val);
void  hsM_15_0(UB  * pcode, scalar  val);
void  hsM_15_5(UB  * pcode, UB  val);
...
void  hsM_27_5(UB  * pcode, UB  val);
void  hsM_28_0(UB  * pcode, scalar  val);
void  hsM_28_5(UB  * pcode, UB  val);
void  hsM_29_0(UB  * pcode, scalar  val);
void  hsM_29_5(UB  * pcode, UB  val);
void  hsM_30_0(UB  * pcode, scalar  val);
void  hsM_30_5(UB  * pcode, UB  val);
...
void  hsM_34_5(UB  * pcode, UB  val);
void  hsM_35_0(UB  * pcode, scalar  val);
void  hsM_35_5(UB  * pcode, UB  val);
...
void  hsM_41_5(UB  * pcode, UB  val);
void  hsM_42_0(UB  * pcode, scalar  val);
void  hsM_42_5(UB  * pcode, UB  val);
void  hsM_43_0(UB  * pcode, scalar  val);
void  hsM_43_5(UB  * pcode, UB  val);
void  hsM_44_0(UB  * pcode, scalar  val);
void  hsM_44_5(UB  * pcode, UB  val);
...
void  hsM_59_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_60_0(UB  * pcode, scalar  val);
void  hsM_61_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_61_6(UB  * pcode, scalar  val, U  I818);
void  hsM_61_7(UB  * pcode, vec32  * I957, U  I818, U  I968);
void  hsM_61_9(UB  * pcode, vec32  * I773);
void  hsM_62_0(UB  * pcode, scalar  val);
void  hsM_63_0(UB  * pcode, scalar  val);
void  hsM_64_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_65_0(UB  * pcode, scalar  val);
void  hsM_66_0(UB  * pcode, scalar  val);
void  hsM_67_0(UB  * pcode, scalar  val);
void  hsM_68_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_68_5(UB  * pcode, U  I716);
